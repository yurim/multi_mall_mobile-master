...
<!--            </div>-->
          ...
          <div class="order_info_wrap">
            <div class="order_info_group">
              <div class="info_title">반품 사유</div>
              <ul>
                <li>
                ...
                <li>
                  ...
                  <div class="content_info">
                    <textarea placeholder="내용을 입력해주세요." v-model="order_product_return.reason"></textarea>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div class="order_info_group">
              <div v-if="selectedReasonObject.responsible_for !== 'SELLER'">
                <div class="info_title" >반품 배송비</div>
                <ul>
                  <li>
              ...
              <ul v-if="order_product_return.collect_fee_type === 'ATTACH'">
                <li class="info_title">반품 배송비 정보 <span class="font_10">(동봉)</span></li>
  ...
  <!--                    todo: 구분선 ? -->
              ...
              <ul v-if="order_product_return.collect_fee_type === 'VBANK'">
                <li class="info_title">반품 배송비 정보 <span class="font_10">(무통장입금)</span></li>
                <li><span class="font_10">아래 표시되는 금액은 참고용이며, 책임여부와 판매자 사정으로 인해 금액이 변동될 수 있습니다.</span></li>
                <li>
                  <div class="cart_table_wrap">
                    <table>
              ...
              <ul v-if="order_product_return.collect_fee_type === 'SELLER_DECIDES'">
                <li class="info_title">반품 배송비 정보 <span class="font_10">(판매자와 상담 후 결정)</span></li>
                <li><span class="font_10">아래 표시되는 금액은 참고용이며, 책임여부와 판매자 사정으로 인해 금액이 변동될 수 있습니다.</span></li>
                <li>
                  <div class="cart_table_wrap">
                    <table>
